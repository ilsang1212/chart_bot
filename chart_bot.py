...
def show_jabco5_chart(update, ctx):
    ...
    data_checker, result_msg = draw_chart(data_db, user_name, ["kpace", "ins"], interval_str)
...
def show_krno_chart(update, ctx):
    ...
    data_checker, result_msg = draw_chart(data_db, user_name, ["klay", "krno", "kredit"], interval_str)
